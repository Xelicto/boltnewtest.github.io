      ...
      <section className="bg-gradient-to-br from-green-600 to-emerald-700 text-white py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            Contact Fer Landscaping
          </h1>
          <p className="text-xl opacity-90 leading-relaxed">
            Ready to transform your outdoor space? Get in touch with Cleveland's trusted landscaping experts for a free consultation and estimate.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Whether you need residential lawn care, commercial landscape design, or any of our comprehensive landscaping services in Cleveland, we're here to help. Fill out the form and we'll get back to you within 24 hours to schedule your free consultation.
              </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Please describe your landscaping needs and any specific requirements..."
                    ></textarea>
                  </div>
                  ...
                  <p className="text-sm text-gray-600 text-center">
                    By submitting this form, you agree to be contacted by Fer Landscaping regarding your inquiry.
                  </p>
                </form>
              )}
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Free Property Assessment</h3>
              <p className="text-gray-700">
                We'll visit your Cleveland property to assess your specific landscaping needs, soil conditions, and opportunities for improvement.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Expert Recommendations</h3>
              <p className="text-gray-700">
                Receive professional advice on the best plants, materials, and landscape design options for your property and budget.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Detailed Estimate</h3>
              <p className="text-gray-700">
                Get a comprehensive, transparent estimate with no hidden fees so you know exactly what to expect.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold text-gray-900 mb-3">No Obligation</h3>
              <p className="text-gray-700">
                Our consultations are completely free with no pressure or obligation to proceed. We're here to help you make informed decisions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-green-600 text-white px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-4 opacity-90">
            Fer Landscaping proudly serves residential and commercial properties throughout the greater Cleveland area, including:
          </p>
          <p className="text-lg opacity-90">
            Lakewood, Shaker Heights, Cleveland Heights, Westlake, Rocky River, Bay Village, Parma, Independence, Strongsville, and all surrounding communities.
          </p>
        </div>
      </section>
    </div>
